...
def install(portal, reinstall=False):
    ...
    setup_tool.runAllImportStepsFromProfile('profile-collective.js.lightbox2:default')
    return "Ran all install steps."


def uninstall(portal, reinstall=False):
    setup_tool = getToolByName(portal, 'portal_setup')
    setup_tool.runAllImportStepsFromProfile('profile-collective.js.lightbox2:uninstall')
